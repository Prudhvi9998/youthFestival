...
$table_name1 = "classical_dance_p";
$table_name2 = "classical_dance_a";
$table_name3 = "classical_dance_s";
...
$query = 'insert into '.$table_name2.' values ("' . $tc . '","' . $cn . '","' . $n4 . '","' . $h4 .'","' . $d4 . '",' . $a4 . ',"' .$c4 . '" )';
...
$query = 'insert into '.$table_name3.' values ("' . $tc . '","' . $cn . '","' . $n5 . '","' . $h5 .'","' . $d5 . '",' . $a5 . ',"' .$c5 . '" )';
...
echo"<h2 align='center'>Classical Dance Registration Details</h2>";
...
echo "<tr><td>" . $tc. "</td><td>" . $cn. "</td> <td>" . $n5. "</td><td>".$h5."</td><td>".$d5."</td><td>".$a5."</td><td>".$c5."</td></tr>";     echo "</table>";  
