...
echo"<h2 align='center'> Quiz Event Registration  Details</h2>";
...
<center><input style='font-size:20px;background:#4CAF50; ' type="button" value="Print" onclick="window.print()"/>&emsp;<button style="background-color:yellow; height:28px;"><a href="Literary_Events.php">Home page</a></button></center>
