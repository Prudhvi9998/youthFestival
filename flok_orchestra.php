...
$table_name1 = " folk_orchestra_p";
$table_name2 = " folk_orchestra_a";
$table_name3 = " folk_orchestra_s";
//$event_code = 199;
//$p_name = "Rama";
//$h_id = "1234";
//$dob = "1996-12-7";
...
$query = 'insert into '.$table_name2.' values ("' . $tc . '","' . $cn . '","' . $n10 . '","' . $h10 .'","' . $d10 . '",' . $a10 . ',"' .$c10 . '" )';
...
$query = 'insert into '.$table_name2.' values ("' . $tc . '","' . $cn . '","' . $n11 . '","' . $h11 .'","' . $d11 . '",' . $a11 . ',"' .$c11 . '" )';
...
$query = 'insert into '.$table_name2.' values ("' . $tc . '","' . $cn . '","' . $n12 . '","' . $h12 .'","' . $d12 . '",' . $a12 . ',"' .$c12 . '" )';
...
$query = 'insert into '.$table_name3.' values ("' . $tc . '","' . $cn . '","' . $n13 . '","' . $h13 .'","' . $d13 . '",' . $a13 . ',"' .$c13 . '" )';
	...
	echo"<h2 align='center'>Folk Orchestra Registration Details</h2>";
