...
$table_name1 = "mehandi_p";
$table_name2 = "mehandi_a";
$table_name3 = "mehandi_s";
//$event_code = 199;
//$p_name = "Rama";
//$h_id = "1234";
//$dob = "1996-12-7";
...
$query = 'insert into '.$table_name3.' values ("' . $tc . '","' . $cn . '","' . $n3 . '","' . $h3 .'","' . $d3 . '",' . $a3 . ',"' .$c3 . '" )';
...
echo"<h2 align='center'>Mehandi Registration  Details</h2>";
...
<input style='font-size:20px;background:#4CAF50; left:20%; ' type="button" value="Print" onclick="window.print()"/>
&emsp;<button style="background-color:yellow; height:28px;"><a href="fine_arts.php">Home page</a></button>
</center>
</body>
</html>
