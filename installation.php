...
$table_name1 = "installation_p";
$table_name2 = "installation_s";
//$event_code = 199;
//$p_name = "Rama";
//$h_id = "1234";
//$dob = "1996-12-7";
...
$query = 'insert into '.$table_name2.' values ("' . $tc . '","' . $cn . '","' . $n5 . '","' . $h5 .'","' . $d5 . '",' . $a5 . ',"' .$c5 . '" )';
...
echo"<h2 align='center'>Installation Event Registration  Details</h2>";
...
echo "<tr><td>" . $tc. "</td><td>" . $cn. "</td> <td>" . $n5. "</td><td>".$h5."</td><td>".$d5."</td><td>".$a4."</td><td>".$c5."</td></tr>";     
echo "</table>";  
