...
$table_name1 = "group_song_indian_p";
$table_name2 = "group_song_indian_a";
$table_name3 = "group_song_indian_s";
//$event_code = 199;
//$p_name = "Rama";
//$h_id = "1234";
//$dob = "1996-12-7";
...
$query = 'insert into '.$table_name2.' values ("' . $tc . '","' . $cn . '","' . $n9 . '","' . $h9 .'","' . $d9 . '",' . $a9 . ',"' .$c9 . '" )';
...
$query = 'insert into '.$table_name3.' values ("' . $tc . '","' . $cn . '","' . $n10 . '","' . $h10 .'","' . $d10 . '",' . $a10 . ',"' .$c10 . '" )';
...
echo"<h2 align='center'>Group Song Indian Registration Details</h2>";
...
echo"</br>";
echo "<table><tr><th>College Code/Team Code</th><th>College_Name</th><th>Accompanists Name</th><th>Phone Number</th><th>Date of Birth </th><th>Age</th><th>Designation</th><tr>";
